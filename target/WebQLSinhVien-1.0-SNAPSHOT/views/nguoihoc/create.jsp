...
<div class="card">
    ...
    <div class="content">
        <form action="/NguoiHoc/store" method="post">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 mb-5 me-4">
                    ...
                    <input class="form-check-input  " type="radio" value="true" checked name="gioiTinh">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Ghi Chú</label>
                        <textarea name="ghiChu"  cols="30" rows="10" class="form-control" ></textarea>
                    </div>
                </div>
            </div>
